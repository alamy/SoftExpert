...
(1, 'Som', 'eletricos', 300, 10),
(2, 'Carṭo de memoria', 'Memoria', 20, 10),
(3, 'ventilador', 'eletricos', 23, 20),
(4, 'notebook', 'eletricos', 300, 20);
...
INSERT INTO `tipo` (`id`, `nomeTipo`, `percentual`, `descricao`) VALUES
